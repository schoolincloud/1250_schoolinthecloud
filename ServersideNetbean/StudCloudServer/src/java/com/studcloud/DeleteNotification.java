...
public class DeleteNotification extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
				...
				if(afile.delete())
				{
						System.out.println("******Delete Query in DeleteNotification******");
						int rowcount1=st.executeUpdate("DELETE FROM uploadnotification WHERE srno='"+srno+"';"); 
						System.out.println("Record DELETED in uploadnotification table..... "+rowcount1);
						rd=request.getRequestDispatcher("uploadNotification.jsp");
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("Record not deleted in uploadnotification table....");
			rd=request.getRequestDispatcher("uploadNotification.jsp");
			rd.forward(request,response);
		}

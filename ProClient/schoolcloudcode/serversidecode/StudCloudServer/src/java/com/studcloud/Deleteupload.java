...
public class Deleteupload extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
				...
				if(afile.delete())
				{
						System.out.println("******Delete Query in Deleteupload******");
						int rowcount1=st.executeUpdate("DELETE FROM uploadfile WHERE srno='"+srno+"';"); 
						System.out.println("Record DELETED in uploadfile table..... "+rowcount1);
						rd=request.getRequestDispatcher("uploadData.jsp");
